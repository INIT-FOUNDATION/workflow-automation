export const USERS = {
    ...
    updateProfile: `UPDATE m_users SET first_name = $2, last_name = $3, email_id = $4, mobile_number = $5, dob = $6, display_name = $7, updated_by = $1, date_updated = NOW() WHERE user_id = $1`,
}