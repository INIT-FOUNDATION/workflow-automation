...
export const workflowController = {
    ...
    create: async (req: Request, res: Response): Promise<Response> => {
        ...
        */
        try {
            ...
            logger.error(`workflowController :: createWorflow :: ${error.message} :: ${error}`);
    ...
    getByworkflowId: async (req: Request, res: Response): Promise<Response> => {
        ...
        */
        try {
            logger.info(`workflowController :: Inside getByworkflowId`);
    ...
    nodesList: async (req: Request, res: Response): Promise<Response> => {
        ...
        */
        try {
            ...
            logger.error(`workflowController :: nodesList :: ${error.message} :: ${error}`);
            return res.status(STATUS.INTERNAL_SERVER_ERROR).send(ERRORCODE.ERROR0001);
        }
    }
}